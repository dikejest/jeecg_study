...
public class SysDepartServiceImpl extends ServiceImpl<SysDepartMapper, SysDepart> implements ISysDepartService {
	...
	@Override
	public SysDepart getSysDepart(String orgCode) {
		return this.baseMapper.getSysDepart(orgCode);
	}
	/**
	 * 根据id查询下级部门
	 * @param pid
	 ...
	 */
	@Override
	public List<String> getIds(String orgCode) {
		QueryWrapper<SysDepart> wrapper = new QueryWrapper<>();
		wrapper.likeRight("org_code",orgCode);
		List<SysDepart> sysDeparts = this.baseMapper.selectList(wrapper);
		List<String> ids = new ArrayList<>();
		sysDeparts.forEach(s->ids.add(s.getId()));
		return ids;
	}
}
