...
<script>
  ...
  export default {
    name: 'CommunitySupplyQuantityForm',
    components: {
    },
    props: {
      //表单禁用
    ...
    data () {
      return {
        ...
        url: {
          add: "/communitySupplyQuantity/communitySupplyQuantity/add",
          edit: "/communitySupplyQuantity/communitySupplyQuantity/edit",
          queryById: "/communitySupplyQuantity/communitySupplyQuantity/queryById"
        }
      }
    },
    computed: {
