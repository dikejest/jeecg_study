<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('疫情物资入库单')">导出</a-button>
    ...
    <community-order-modal ref="modalForm" @ok="modalFormOk"></community-order-modal>
  </a-card>
</template>
...
<script>
  ...
  import CommunityOrderModal from './modules/CommunityOrderModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/communityOrder/communityOrder/list",
          delete: "/communityOrder/communityOrder/delete",
          deleteBatch: "/communityOrder/communityOrder/deleteBatch",
          exportXlsUrl: "/communityOrder/communityOrder/exportXls",
          importExcelUrl: "communityOrder/communityOrder/importExcel",
